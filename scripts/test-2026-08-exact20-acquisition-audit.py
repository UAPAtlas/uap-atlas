...
require(len(data["cases"]) == 159, "case count drifted")
require(len(data["timeline"]) == 157, "timeline count drifted")
...
print("PASS: exact-20 acquisition audit (20 ranked existing cases; 159 cases / 157 timeline)")
